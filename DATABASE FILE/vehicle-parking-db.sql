...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 20, 2023 at 10:01 AM
...
INSERT INTO `trigr` (`tid`, `Vcategory`, `action`, `timestamp`, `catid`) VALUES
(1, 'Ships', 'CATEGORY DELETED', '2023-01-20 14:14:55', 10),
(2, 'VIP', 'CATEGORY DELETED', '2023-01-20 14:20:54', 12),
(3, 'VIP', 'CATEGORY INSERTED', '2023-01-20 14:25:50', 13);
...
(7, 'Bus', '6', '2023-01-20 08:32:12'),
(8, 'Helicopter', 'Fly', '2023-01-20 08:33:29'),
(9, 'Airplane', 'Fly', '2023-01-20 08:33:55'),
(11, 'Truck', '8', '2023-01-20 08:34:44'),
(13, 'VIP', 'vip', '2023-01-20 08:55:50');

--
-- Triggers `vcategory`
--
DELIMITER $$
CREATE TRIGGER `CatDelete` BEFORE DELETE ON `vcategory` FOR EACH ROW INSERT INTO trigr VALUES(null,OLD.VehicleCat,'CATEGORY DELETED',NOW(),OLD.ID)
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `Catinsertion` AFTER INSERT ON `vcategory` FOR EACH ROW INSERT INTO trigr VALUES(null,NEW.Vehiclecat,'CATEGORY INSERTED',NOW(),NEW.ID)
$$
DELIMITER ;
...
(11, '03289', 'Four Wheeler', 'Volkswagen', 'STT-7002', 'Colin Greenwood', 2574442560, '2021-03-08 13:50:15', '2023-01-20 08:31:31', '10', '2 year', 'Out'),
